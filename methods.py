...
def followers_get(id, token, v):
    data = {"user_id": id,
            "offset": 0,
            "count": 1000,
            "fields": "uid,first_name,last_name,sex,bdate,city,country,home_town,last_seen,status,"
                      "photo_max,photo_max_orig,lists,domain,has_mobile,counters,occupation,nickname,relatives,"
...
def groups_get(id, token, v):
    data = {"user_id": id,
            "extended": 1,
            "fields": "id,name,screen_name,invited_by,type,"
                      "has_photo,photo_200,activity,age_limits,"
                      "city,contacts,counters,country,"
                      "cover,description,fixed_post,main_album_id,main_section,market,members_count,place,"
                      "public_date_label,site,status,trending,wiki_page",
        "offset": 0,
        "count": 1000}
